...
public class TCS34725 {
    ...
    // State Variables
    private boolean sensor_initalized;/** True if sensor has been initialized, false if not */
    private boolean good_data_read;/** True if the last read from the sensor was good, bad if data was corrupted */
    private int red_val;
